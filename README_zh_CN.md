...
> 兼容性提示：本插件可在思源 3.6.5 及以上版本安装，但完整的内核插件 HTTP 与流式代理能力需要思源 3.7.0 及以上版本。若要体验完整功能，可以尝试下载思源最新 dev 版本。
...
1. 使用思源 3.7.0 或以上版本进行完整功能验证。插件可以在 3.6.5+ 安装，但 3.7.0 之前可能缺少部分内核插件 HTTP/代理能力。
...
- 思源 3.6.5 是最低安装版本。完整的文件路由、播放和代理行为需要思源 3.7.0 或以上版本，并具备内核插件 HTTP `body.proxy` 能力，相关能力见 SiYuan PR #17748。
