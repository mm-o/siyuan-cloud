...
const buildDriverInfoMap = () => withAliases({
  ...
  "GitHub Releases": configPatch(supported("GitHub Releases", [
    rootPath("/"),
    field("repo_structure", "text", "OpenListTeam/OpenList", "", true, "structure:[path:]org/repo"),
    bool("show_readme", true, "show README/LICENSE file"),
    password("token", false, "GitHub token, if you want to access private repositories or increase the rate limit"),
    bool("show_source_code", false, "show Source code (zip/tar.gz)"),
    bool("show_all_version", false, "show all versions"),
    text("gh_proxy", false, "GitHub proxy, e.g. https://ghproxy.net/github.com or https://gh-proxy.com/github.com"),
  ]), {
    no_upload: true,
    note: "Runtime ports OpenList GitHub Releases list/get/read/link behavior. Management and upload operations remain OpenList NotImplement.",
  }),
