...
export const createPublicHandlers = ({
  ...
  const apiIndex = () => ({
    ...
    capabilities: [
      ...
      "openlist.webdav",
      "openlist.s3",
      "openlist.fs.torrent.parse",
      "openlist.fs.torrent.generate",
      "openlist.fs.torrent.rapid-upload.driver-boundary",
      "openlist.fs.archive.zip-list",
      "openlist.fs.archive.zip-extract-stored",
      "openlist.fs.archive.zip-extract-deflate",
      "openlist.fs.archive.zip-encrypted-detect",
      "openlist.fs.archive.zip-decompress-virtual",
      "openlist.fs.archive.decompress-upload-mounted",
      "openlist.fs.archive.tar-list",
      "openlist.fs.archive.tar-extract",
      "openlist.fs.archive.tgz-list",
      "openlist.fs.archive.tgz-extract",
      "openlist.share.archive.zip-extract",
      "openlist.share.archive.meta-list",
      "openlist.fs.archive.driver-paths",
    ],
    notes: [
